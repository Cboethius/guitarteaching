...
const de = {
  ...
  testimonials: {
    ...
    replyLabel: "Antwort von Christian",
  ...
  testimonialReview: {
    ...
    intro: "Schreiben Sie kurz, wie der Unterricht für Sie war.",
    quote: "Zitat",
  ...
  adminTestimonials: {
    ...
    replyLabel: "Ihre Antwort (optional)",
    replyHint: "Antwort auf diese Rückmeldung für die öffentliche Anzeige",
...
const en = {
  ...
  testimonials: {
    ...
    replyLabel: "Reply from Christian",
  ...
  testimonialReview: {
    ...
    intro: "Write your testimonial and submit it.",
    quote: "Quote",
  ...
  adminTestimonials: {
    ...
    replyLabel: "Your reply (optional)",
    replyHint: "Response shown publicly below this testimonial",
