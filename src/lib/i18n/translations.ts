...
const de = {
    ...
    pillars: [
      {
        ...
        body: "Fingerkraft, Auge-Hand-Koordination, Rhythmus und Timing. Was die linke und die rechte Hand jeweils tun, mit sauberer Technik und der richtigen Haltung von Körper und Händen.",
      },
      {
        title: "Die Gitarre verstehen",
        body: "Die Teile beim Namen nennen, wie das Instrument funktioniert, Saiten wechseln und stimmen, kleine Pflege, damit deine Gitarre lange gut klingt.",
      },
      {
        title: "Musiktheorie für Gitarre",
        body: "Akkorde, Tabs, Akkordfolgen, Tonleitern, Intervalle und etwas Gehörtraining. Songs verstehen und wie sie aufgebaut sind.",
      },
    ],
  ...
  pricing: {
    ...
    ctaRegular: "Erwachsene/Teens buchen",
    ctaChild: "Unter 14 buchen",
    childBookHint: "Kinder: Buchung durch Erziehungsberechtigte",
  ...
  book: {
    ...
    inclFee: "inkl. kleiner Bearbeitungsgebühr",
  ...
  success: {
    title: "Danke",
    payDirect:
      "Bitte überweise {amount} CHF per TWINT oder Bank. Der Termin gilt als bestätigt, sobald die Zahlung eingegangen ist.",
    account: "Konto",
  ...
  cancel: {
    ...
    body: "Es wurde nichts belastet. Du kannst es erneut versuchen oder direkt bezahlen.",
...
const en = {
  ...
  about: {
    ...
    pillarsBody: [
      ...
      "**It's not about reaching the summit** as fast as possible, but enjoying the journey, **building small wins** along the way rather than chasing big ones and getting discouraged.",
    ],
    pillars: [
      {
  ...
  pricing: {
    ...
    ctaRegular: "Adults/teens book",
    ctaChild: "Under 14 book",
    childBookHint: "Children: parent or guardian books on behalf of child",
    zoomTitle: "Zoom (online)",
